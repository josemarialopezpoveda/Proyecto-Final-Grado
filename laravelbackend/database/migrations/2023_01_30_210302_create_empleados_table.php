...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('empleados', function (Blueprint $table) {
            ...
            $table->string('nif', 15)->unique()->comment('NIF del empleado');
            ...
            $table->string('email', 200)->unique()->comment('Correo electrónico del empleado');
            $table->string('password', 200)->comment('Contraseña del empleado');
            $table->unsignedBigInteger('numSegSoc')->unique()->comment('Número de Seguridad Social del empleado');
            $table->string('fotografia')->nullable()->comment('Ruta de la fotografía del empleado');
