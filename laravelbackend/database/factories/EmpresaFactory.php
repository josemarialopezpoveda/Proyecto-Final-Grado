...
class EmpresaFactory extends Factory {
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'razonSocial' => mb_strtoupper($faker->company, 'UTF-8'),
            'nombreComercial' => mb_strtoupper($faker->company, 'UTF-8'),
            'direccion' => mb_strtoupper($faker->streetName(), 'UTF-8') . ', ' . $faker->buildingNumber(),
