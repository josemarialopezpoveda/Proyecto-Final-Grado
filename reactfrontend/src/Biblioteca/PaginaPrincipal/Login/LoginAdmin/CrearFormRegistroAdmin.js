    ...
    <React.Fragment>
      <Form>
          ...
          <div className="divFlex divFlexquitar">
            <div className="cajaPasswordLogin">
              <Form.Group className="mb-3">
                ...
                />
                <FontAwesomeIcon
                  className="btnOcultar3"
                  icon={contextoReg.verContrasenya}
            ...
            <div className="cajaPasswordLogin">
              <Form.Group className="mb-3">
                ...
                <FontAwesomeIcon
                  className="btnOcultar3"
                  icon={contextoReg.verContrasenyaConfirmada}
        ...
        <p className="botonCrearCuentaEmpresa">
          <button type="button" id="signIn" onClick={TodoCorrecto} className="linkSignInLogin">
            CREAR CUENTA
          </button>
          <Link id="signIn" className="linkSignInLogin" to="/loginAdmin">
            VOLVER
          </Link>
        </p>
      </Form>
