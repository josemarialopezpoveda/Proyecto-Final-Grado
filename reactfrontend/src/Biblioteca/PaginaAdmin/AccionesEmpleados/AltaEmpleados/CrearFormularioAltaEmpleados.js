...
import { checkDNI, formatDate, formatearFechaHora, validarNumSecSoc, peticionPost,
mostrarAlertaCorrecta, mostrarAlertaErronea } from '../../../FuncionesAuxiliares/Funciones';
                  ...
                  <div className='divContenedorCampo2'>
                        <div className='divContenedorCampo'>
                              ...
                              <Form.Group className="grupoInputPequenyo">
                                    ...
                                    isValid={validarCampos(/^(0[1-9]|[12][0-9]|3[01])\/(0[1-9]|1[012])\/\d{4}$/.test(formatDate(form.fnac)))}
                                    isInvalid={validarCampos(!/^(0[1-9]|[12][0-9]|3[01])\/(0[1-9]|1[012])\/\d{4}$/.test(formatDate(form.fnac)))}/>
                              </Form.Group>
                        </div>
                        <div className='divContenedorCampo'>
                              <p className='letrapequenya'>Fecha de alta</p>
                              <Form.Group className="grupoInputPequenyo">
                                    <Form.Control  size="lg" type="date" onChange={e=>setForm({...form,fechaAlta:e.target.value.trim()})}
                                    isValid={validarCampos(/^(0[1-9]|[12][0-9]|3[01])\/(0[1-9]|1[012])\/\d{4}$/.test(formatDate(form.fechaAlta)))}
                                    isInvalid={validarCampos(!/^(0[1-9]|[12][0-9]|3[01])\/(0[1-9]|1[012])\/\d{4}$/.test(formatDate(form.fechaAlta)))}/>
                              </Form.Group>
                        </div>
                  </div>
                  <div className='divContenedorCampo'>
                  ...
                  <div className="divContenedorCampo cajaPasswordLogin">
                        ...
                        <Form.Group className="mb-3 width500">
                              <Form.Control size="lg" type="password"
                                    ref={passwordInput}
                                    isValid={validarCampos(/^(?!.*[{}[\]<>;:&])(?=\w*\d)(?=\w*[A-Z])(?=\w*[a-z])\S{6,20}$/.test(form.contrasenya))}
                                    isInvalid={validarCampos(!/^(?!.*[{}[\]<>;:&])(?=\w*\d)(?=\w*[A-Z])(?=\w*[a-z])\S{6,20}$/.test(form.contrasenya))}
